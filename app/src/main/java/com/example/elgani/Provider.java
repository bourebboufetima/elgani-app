...
public class Provider extends AppCompatActivity implements ProfessionAdapter.OnItemClickListener{
        ...
        public void onItemClick(String professionName) {
            if (professionName.equals("Programmer")) {
                Intent intent = new Intent(this, CahierListActivity.class);
